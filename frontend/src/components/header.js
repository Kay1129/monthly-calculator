...
const navigation = [
    { name: 'Dashboard', link:"/MonthlyCalculator/dashboard"},
    { name: 'Register Entry', link:"/MonthlyCalculator/registerForm" },
    { name: 'Expense Detail', link:"/MonthlyCalculator/expenseDetail" },
    { name: 'Annual Summary', link:"/MonthlyCalculator/annualSummary" },
]
