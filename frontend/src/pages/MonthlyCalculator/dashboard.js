...
export default function Example() {
    ...
    useEffect(() => {
        ...
        console.log("test current Month "+currentDate.getMonth())
        console.log(dbDate)
        ...
        //test dbDate
        const testDbDate = "2025-November"
                    ...
                    <div className="relative isolate overflow-hidden pt-16 ">
                        ...
                        <header className="pb-4 pt-6 sm:pb-6">
                            <div className="mx-auto flex max-w-7xl flex-wrap items-center gap-6 px-4 sm:flex-nowrap sm:px-6 lg:px-8">
                                ...
                                <Link to="/MonthlyCalculator/registerForm"
                                    href="#"
                                ...
                                {dashboardUnsortedData.sortedExpenseSummary.map((item, index) => (
                                    <div
                                        ...
                                        className={classNames(
                                            ...
                                            (index+1) <5 ? 'sm:border-t-2 sm:border-b- mb-2' : 'sm:border-b-2',
